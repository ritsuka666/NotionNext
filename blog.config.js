...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '探索最佳商业实践', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://businessaward.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '商业,科技,AI,管理,信息化', // 网站关键词 英文逗号隔开
